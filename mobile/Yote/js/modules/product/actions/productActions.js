...
export function fetchSingleProductById(productId) {
  ...
  return dispatch => {
    ...
    return fetch(`${rootUrl}/api/products/${productId}`)
...
export function sendCreateProduct(data) {
  ...
  return dispatch => {
    ...
    return fetch(`${rootUrl}/api/products`, 'POST', data)
...
export function sendUpdateProduct(data) {
  return dispatch => {
    ...
    return fetch(`${rootUrl}/api/products/${data._id}`, 'PUT', data)
...
export function sendDelete(id) {
  return dispatch => {
    ...
    return fetch(`${rootUrl}/api/products/${id}`, 'DELETE')
...
export function fetchList() {
  ...
  return dispatch => {
    ...
    return fetch(`${rootUrl}/api/products`, {
      method: 'GET'
      , headers: {
