...
var dbName = "yote";
// var remoteDb = "10.240.0.29"; //TODO: grab from ENV variable
...
module.exports = {
  ...
  // , production: {
  //   db: process.env.MONGODB_PORT ? process.env.MONGODB_PORT.replace("tcp", "mongodb") + "/" + dbName : 'mongodb://' + dbLocation + '/' + dbName
  //   , redis: {
  //     host: process.env.REDIS_PORT ? process.env.REDIS_PORT.replace("tcp://", "").split(":")[0] : "localhost"
  //     , port: process.env.REDIS_PORT ? process.env.REDIS_PORT.replace("tcp://", "").split(":")[1] : "6379"
  //   }
